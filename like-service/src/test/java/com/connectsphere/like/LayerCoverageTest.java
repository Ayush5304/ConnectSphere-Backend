...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.like.config.AppConfig",
        "com.connectsphere.like.config.CorsConfig",
        "com.connectsphere.like.config.SecurityConfig",
        "com.connectsphere.like.config.SwaggerConfig",
        "com.connectsphere.like.controller.LikeResource",
        "com.connectsphere.like.entity.Like",
        "com.connectsphere.like.exception.BadRequestException",
        "com.connectsphere.like.exception.GlobalExceptionHandler",
        "com.connectsphere.like.exception.ResourceNotFoundException",
        "com.connectsphere.like.repository.LikeRepository",
        "com.connectsphere.like.service.LikeService"
    );
