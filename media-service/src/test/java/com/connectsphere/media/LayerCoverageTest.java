...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.media.config.CorsConfig",
        "com.connectsphere.media.config.S3Config",
        "com.connectsphere.media.config.SecurityConfig",
        "com.connectsphere.media.config.SwaggerConfig",
        "com.connectsphere.media.controller.MediaResource",
        "com.connectsphere.media.entity.Story",
        "com.connectsphere.media.entity.StoryView",
        "com.connectsphere.media.repository.StoryRepository",
        "com.connectsphere.media.repository.StoryViewRepository",
        "com.connectsphere.media.service.MediaService"
    );
