...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.follow.config.AppConfig",
        "com.connectsphere.follow.config.CorsConfig",
        "com.connectsphere.follow.config.SecurityConfig",
        "com.connectsphere.follow.config.SwaggerConfig",
        "com.connectsphere.follow.controller.FollowResource",
        "com.connectsphere.follow.entity.Follow",
        "com.connectsphere.follow.entity.FollowRequest",
        "com.connectsphere.follow.exception.GlobalExceptionHandler",
        "com.connectsphere.follow.repository.FollowRepository",
        "com.connectsphere.follow.repository.FollowRequestRepository",
        "com.connectsphere.follow.service.FollowService"
    );
