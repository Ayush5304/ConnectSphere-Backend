...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.auth.config.AdminAccountInitializer",
        "com.connectsphere.auth.config.SwaggerConfig",
        "com.connectsphere.auth.controller.AuthResource",
        "com.connectsphere.auth.entity.User",
        "com.connectsphere.auth.exception.BadRequestException",
        "com.connectsphere.auth.exception.GlobalExceptionHandler",
        "com.connectsphere.auth.exception.ResourceNotFoundException",
        "com.connectsphere.auth.repository.UserRepository",
        "com.connectsphere.auth.security.JwtFilter",
        "com.connectsphere.auth.security.JwtUtil",
        "com.connectsphere.auth.security.OAuth2SuccessHandler",
        "com.connectsphere.auth.security.SecurityConfig",
        "com.connectsphere.auth.service.AuthService"
    );
