...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.comment.config.AppConfig",
        "com.connectsphere.comment.config.CorsConfig",
        "com.connectsphere.comment.config.SecurityConfig",
        "com.connectsphere.comment.config.SwaggerConfig",
        "com.connectsphere.comment.controller.CommentResource",
        "com.connectsphere.comment.entity.Comment",
        "com.connectsphere.comment.exception.BadRequestException",
        "com.connectsphere.comment.exception.GlobalExceptionHandler",
        "com.connectsphere.comment.exception.ResourceNotFoundException",
        "com.connectsphere.comment.repository.CommentRepository",
        "com.connectsphere.comment.service.CommentService"
    );
