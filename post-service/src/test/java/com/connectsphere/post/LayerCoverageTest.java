...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.post.config.AppConfig",
        "com.connectsphere.post.config.CorsConfig",
        "com.connectsphere.post.config.RedisConfig",
        "com.connectsphere.post.config.SecurityConfig",
        "com.connectsphere.post.config.SwaggerConfig",
        "com.connectsphere.post.controller.PostResource",
        "com.connectsphere.post.entity.Post",
        "com.connectsphere.post.exception.BadRequestException",
        "com.connectsphere.post.exception.GlobalExceptionHandler",
        "com.connectsphere.post.exception.ResourceNotFoundException",
        "com.connectsphere.post.repository.PostRepository",
        "com.connectsphere.post.service.PostService",
        "com.connectsphere.post.service.PostServiceImpl"
    );
