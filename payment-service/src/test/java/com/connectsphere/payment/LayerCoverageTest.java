...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.payment.config.AppConfig",
        "com.connectsphere.payment.config.SecurityConfig",
        "com.connectsphere.payment.config.SwaggerConfig",
        "com.connectsphere.payment.controller.PaymentController",
        "com.connectsphere.payment.dto.CreateOrderRequest",
        "com.connectsphere.payment.dto.CreateOrderResponse",
        "com.connectsphere.payment.dto.VerifyPaymentRequest",
        "com.connectsphere.payment.entity.Payment",
        "com.connectsphere.payment.exception.BadRequestException",
        "com.connectsphere.payment.exception.GlobalExceptionHandler",
        "com.connectsphere.payment.exception.ResourceNotFoundException",
        "com.connectsphere.payment.repository.PaymentRepository",
        "com.connectsphere.payment.service.PaymentService"
    );
