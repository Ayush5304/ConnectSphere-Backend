...
class LayerCoverageTest {
    ...
    private static final List<String> CLASSES = List.of(
        "com.connectsphere.notification.config.CorsConfig",
        "com.connectsphere.notification.config.RabbitConfig",
        "com.connectsphere.notification.config.SecurityConfig",
        "com.connectsphere.notification.config.SwaggerConfig",
        "com.connectsphere.notification.controller.NotificationResource",
        "com.connectsphere.notification.entity.Notification",
        "com.connectsphere.notification.exception.GlobalExceptionHandler",
        "com.connectsphere.notification.repository.NotificationRepository",
        "com.connectsphere.notification.service.NotificationService"
    );
